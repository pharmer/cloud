...
func (c *credentials) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.Credential, err error) {
...
func (c *credentials) List(ctx context.Context, opts metav1.ListOptions) (result *v1.CredentialList, err error) {
...
func (c *credentials) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *credentials) Create(ctx context.Context, credential *v1.Credential, opts metav1.CreateOptions) (result *v1.Credential, err error) {
	result = &v1.Credential{}
	err = c.client.Post().
		Resource("credentials").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *credentials) Update(ctx context.Context, credential *v1.Credential, opts metav1.UpdateOptions) (result *v1.Credential, err error) {
	result = &v1.Credential{}
	err = c.client.Put().
		Resource("credentials").
...
func (c *credentials) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *credentials) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *credentials) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.Credential, err error) {
	result = &v1.Credential{}
