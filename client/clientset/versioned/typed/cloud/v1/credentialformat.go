...
func (c *credentialFormats) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.CredentialFormat, err error) {
...
func (c *credentialFormats) List(ctx context.Context, opts metav1.ListOptions) (result *v1.CredentialFormatList, err error) {
...
func (c *credentialFormats) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *credentialFormats) Create(ctx context.Context, credentialFormat *v1.CredentialFormat, opts metav1.CreateOptions) (result *v1.CredentialFormat, err error) {
	result = &v1.CredentialFormat{}
	err = c.client.Post().
		Resource("credentialformats").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *credentialFormats) Update(ctx context.Context, credentialFormat *v1.CredentialFormat, opts metav1.UpdateOptions) (result *v1.CredentialFormat, err error) {
	result = &v1.CredentialFormat{}
	err = c.client.Put().
		Resource("credentialformats").
...
func (c *credentialFormats) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *credentialFormats) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *credentialFormats) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.CredentialFormat, err error) {
	result = &v1.CredentialFormat{}
