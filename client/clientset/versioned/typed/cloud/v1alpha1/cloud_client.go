...
func (c *CloudV1alpha1Client) CredentialFormats() CredentialFormatInterface {
	return newCredentialFormats(c)
}

func (c *CloudV1alpha1Client) KubernetesVersions() KubernetesVersionInterface {
	return newKubernetesVersions(c)
}
