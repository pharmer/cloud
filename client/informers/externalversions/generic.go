...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("credentialformats"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cloud().V1alpha1().CredentialFormats().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("kubernetesversions"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cloud().V1alpha1().KubernetesVersions().Informer()}, nil
